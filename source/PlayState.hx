...
class PlayState extends MusicBeatState
{
	...
	function startSong():Void
	{
		...
		if (!paused)
	    {
	        ...
	        {
            FlxG.sound.playMusic(Paths.instb(PlayState.SONG.song), 1, false);
			}
		    else
			{
	...
	private function generateSong(dataPath:String):Void
	{
		...
		curSong = songData.song;
				...
				{
				    if (SONG.needsVoices)
					    vocals = new FlxSound().loadEmbedded(Paths.voicesb(PlayState.SONG.song));
				    else
					    vocals = new FlxSound();
			    }
				else
	...
	override public function update(elapsed:Float)
	{
		...
		scoreTxt.text = "Score:" + songScore + "| Misses:" + misses + "| Song name:" + SONG.song + "| MADE BY RP4 AND KLAV | Health:" + healthBar.percent + "%";
